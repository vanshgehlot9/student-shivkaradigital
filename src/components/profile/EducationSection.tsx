...
import { GraduationCap, Plus, Calendar, MapPin, Edit, Database, Pencil } from "lucide-react";
        ...
        >
            <div className="relative bg-[#0A0A0A]/60 backdrop-blur-md border border-white/[0.08] rounded-xl p-8 transition-all duration-300 group-hover:bg-[#0A0A0A]/80 group-hover:border-blue-500/30 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
                ...
                <button
                    ...
                    className="absolute top-6 right-6 text-zinc-600 hover:text-white transition-colors opacity-0 group-hover:opacity-100 z-20 p-2 hover:bg-white/5 rounded-lg"
                >
                    <Pencil size={14} />
                </button>
                ...
                <div className="flex items-start gap-6 relative z-10" style={{ transform: "translateZ(20px)" }}>
                    ...
                    <div className="flex-grow">
                        ...
                        <p className="text-sm font-medium text-zinc-400 mt-1">{education.degree}</p>
            ...
            <div className="space-y-8 animate-in fade-in leading-relaxed">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 text-xs font-bold bg-white text-black uppercase tracking-wider hover:bg-[#F24E1E] hover:text-white px-5 py-3 rounded transition-colors shadow-[0_0_15px_rgba(255,255,255,0.1)]"
                    >
                        <Pencil size={14} />
                        Add Edit Detail
                    </button>
                ...
                <div className="grid grid-cols-1 gap-6">
                    {education.length === 0 ? (
                        <div className="text-center py-12 border border-dashed border-white/10 rounded-xl">
                            ...
                            <p className="text-zinc-600 text-xs mt-1">Click &quot;Add Edit Detail&quot; to add your academic qualifications</p>
                        </div>
                    ) : (
